...
public class UITexture : UIBasicSprite
{
...
#else
                mCacheTexture = Resources.Load<Texture>(texturePath.Replace("Assets/Resources/", "").Replace(".png",""));
#endif
            }
    ...
    [HideInInspector][SerializeField] string mTexturePath;
    ...
    protected override void OnDisable()
    {
        ...
        if (!string.IsNullOrEmpty(texturePath))
        {
            ...
            if (textureList.ContainsKey(relativePath) && textureList[relativePath].Contains(this))
                textureList[relativePath].Remove(this);
        }
    }
    ...
    public static string ToTextureLog()
    {
        StringBuilder buf = new StringBuilder();

        foreach (string key in textureList.Keys)
        {
            buf.AppendFormat("key:{0},count:{1}\n", key, textureList[key].size);
        }
