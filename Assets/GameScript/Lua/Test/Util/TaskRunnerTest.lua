	...
	[TestFixture]
local TaskRunnerTests = class("TaskRunnerTests")
	
		[SetUp]
function  TaskRunnerTest.Setup ()
...
function  TaskRunnerTest.TestSingleEnumerationBlockExecution()
...
function  TaskRunnerTest.TestEnumerableAreExecutedInSerial()
...
function  TaskRunnerTest.TestEnumerableAreExecutedInParallel()
...
function  TaskRunnerTest.TestSingleTaskExecution()
...
function  TaskRunnerTest.TestSingleTaskExecutionCallsOnComplete()
...
function  TaskRunnerTest.TestSerializedTasksAreExecutedInSerial()
...
function  TaskRunnerTest.TestTask1IsExecutedBeforeTask2()
...
function  TaskRunnerTest.TestEnumerable1AndTask2AreExecutedInParallel()
...
function  TaskRunnerTest.TestParallelTasks1IsExecutedBeforeParallelTask2 ()
...
function  TaskRunnerTest.TestParallelTasksAreExecutedInSerial ()
...
function  TaskRunnerTest.TestSerialTasks1ExecutedInParallel ()
...
function  TaskRunnerTest.TestSerialTasks2ExecutedInParallel ()
...
function  TaskRunnerTest.TestSerialTasksAreAllExecutedInParallel ()
...
function  TaskRunnerTest.TestSerialTasksExecutedInParallelWithEnumFunction ()
...
function Task:OnComplete(System.Action<bool> action)
...
function Task:ctor(niterations)
...
function Enumerable:SetupAndRunSerialTasks ()
...
function Enumerable:SetupAndRunParallelTasks ()
