...
//        public string Controller;
...
#if UNITY_EDITOR
        public bool BuildPanel(XmlDocument doc , GameObject root , bool isRoot)
        {
            this.isRoot = isRoot;
            ...
            string templetPath = root == this.gameObject
                                ? GenLuaConst.LuaPanelTempletPath
                                : GenLuaConst.LuaSubPanelTempletPath;
        ...
        private void writeScriptFile(List<UIPanelRoot> panelRoots, List<UIGenFlag> flags , string templetPath)
        {
            ...
            buf.AppendLine("\t\t{field=\"root\", path =\"\", src=LuaCanvas},");
            ...
            if (!string.IsNullOrEmpty(assetPath))
                assetPath = assetPath.Replace(GResource.RuntimeAssetsRoot, "").Replace(".prefab" , "");
        ...
        private string formatExport(UIGenFlag genFlag)
        {
            ...
            else if (genFlag.ScriptType == typeof(RawImage).Name)
            {
                buf.Append("src=LuaTexture");
            }
