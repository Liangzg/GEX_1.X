    ...
    public class zstring
    {
        ...
        public int LastIndexOf(string value)
        {
            ...
            while (true)
            {
                ...
                last_find = idx;
                if ((last_find != -1 && last_find + 1 <= this._value.Length) || idx == -1 || idx + value.Length >= this._value.Length)
                    break;
            }
            return last_find;
        }
        ...
        public int LastIndexOf(char value)
        {
            ...
            while (true)
            {
                ...
                last_find = idx;
                if ((last_find != -1 && last_find + 1 <= this._value.Length) || idx == -1 || idx + 1 >= this._value.Length)
                    break;
            }
            return last_find;
        }
